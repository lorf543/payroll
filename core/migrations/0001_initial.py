    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('break_duraction', models.IntegerField(blank=True, null=True)),
                ...
                ('shutdown_time', models.TimeField(blank=True, null=True)),
                ...
                ('bonus_type', models.CharField(blank=True, choices=[('percent', 'Percentage'), ('fixed', 'Fixed Amount')], max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(blank=True, null=True)),
                ('annual_budget', models.DecimalField(decimal_places=2, default=0, max_digits=12, validators=[django.core.validators.MinValueValidator(0)])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaigns', models.ManyToManyField(blank=True, related_name='employees', to='core.campaign')),
                ('current_campaign', models.ForeignKey(blank=True, help_text='Campaign where the employee is currently active.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='active_employees', to='core.campaign')),
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.department')),
                ('supervisor', models.ForeignKey(blank=True, help_text='Direct supervisor', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='team_members', to='core.employee')),
